...
Estado: E08.1, E08.2, E08.3, E08.4 e E08.5 CONCLUÍDAS (itens abaixo); demais itens (E08.6+) pendentes.
...
Evidência E08.1/E08.2/E08.3/E08.4/E08.5: `diagnostics/e08-onboarding.test.cjs` (6 cenários), `diagnostics/e08-existing-user.test.cjs` (5 cenários de ponta a ponta), `diagnostics/e08-hoje-greeting-numbers.test.cjs` (4 cenários: instalação limpa, diário parcial com nome, legado sem nome, diário populado), `diagnostics/e08-4-edit-goal.test.cjs` (3 cenários: salvar meta válida, salvar meta inválida, cancelar) e `diagnostics/e08-5-hoje-recommendation.test.cjs` (8 cenários: continuidade da seleção, sem programa oferece escolha explícita, seleção explícita grava e reflete, ID inválido não fabrica escolha, e 4 cenários de desempate); HTMLs byte-equivalentes; `bash scripts/check.sh` → BUILD SUCCESSFUL. Limitação: edição de nome (Perfil) e demais itens restantes do checklist ("Começar agora"/atalhos, avatar/lembretes) ainda não implementados — ficam para E08.6+.
